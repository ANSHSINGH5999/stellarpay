          ...
          <div>
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              ...
              {parseFloat(balance) > 1 && (
                <button
                  onClick={() => {
                    const maxXlm = Math.max(0, parseFloat(balance) - 1.001);
                    setAmountInr(String(Math.floor(maxXlm * xlmRate)));
                  }}
                  className="text-xs px-3 py-1.5 rounded-lg border border-emerald-500/40 text-emerald-400 hover:bg-emerald-500/10 transition-colors"
                >
                  Max
                </button>
              )}
